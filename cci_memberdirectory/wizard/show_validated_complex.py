...
class show_validated_complex(models.TransientModel):
    _name = 'show.validate.complex'
    
    @api.multi
    def show_validated_complex(self):
        ...
        addr_ids = obj_addr.search([('user_validated', '=', True), ('internal_validated', '=', False)])
        ...
        value = {
            ...
            'name': 'Complex Validated Address Proxy',
            'view_type': 'form',
            'view_mode': 'tree,form',
