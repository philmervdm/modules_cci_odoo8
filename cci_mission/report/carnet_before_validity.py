...
class carnet_before_val(models.AbstractModel):
    _name = 'report.cci_mission.carnet_before_validity'
    _inherit = 'report.abstract_report'
    _template = 'cci_mission.carnet_before_validity'
    _wrapped_report_class = carnet_before_validity
